...
class SupervisorControls extends HTMLElement {
  ...
  connectedCallback() {
    ...
    var org = this.orgId || "b53b5abb-c810-4e5e-9dd3-c386de6837a7";

    var context = this.shadowRoot;
    var username = this.User || "dhl";
    var passphrase = this.passPhrase || "Pa55w0rd";
    var access_token;
    var triggerurl =
      "https://us-central1-tata-dhlsc-demo.cloudfunctions.net/tcl-token-service";
    var tokenname = "sample";
    ...
    function GetGlobalVariables(result) {
      ...
      fetch(
        "https://api.wxcc-us1.cisco.com/organization/" +
          org +
          "/v2/cad-variable" +
          searchstring,
        requestOptions
