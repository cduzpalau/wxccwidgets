...
class SupervisorControls extends HTMLElement {
  ...
  connectedCallback() {
    ...
    var org = this.orgId || "e4062ebe-e25b-42ef-b11f-a4dc7b502277";

    var context = this.shadowRoot;
    var username = this.User || "cpalau";
    var passphrase = this.passPhrase || "password";
    var access_token;
    var triggerurl =
      "https://europe-west3-clteccct-poc-0map.cloudfunctions.net/token-service";
    var tokenname = "wxcceu2";
    ...
    function GetGlobalVariables(result) {
      ...
      fetch(
        "https://api.wxcc-eu2.cisco.com/organization/" +
          org +
          "/v2/cad-variable" +
          searchstring,
        requestOptions
